...
│   ├── strategy/      # 트레이딩 전략 (value, momentum, market_timing, factor_combiner, multi_factor)
...
- **Phase 3**: 멀티팩터 + 자산배분 (3팩터 모델, 듀얼 모멘텀)
- **Phase 4**: 고도화 (리스크 패리티, ML 실험, 실전 매매 시스템, 스케줄러, install script)
